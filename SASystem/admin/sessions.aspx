<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="sessions.aspx.cs" Inherits="SASystem.admin.sessions" %>
                ...
                <div class="card">
                        ...
                        <div class="col-sm-12" id="divSetSession" runat="server">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sasyCon %>" SelectCommand="SELECT DISTINCT [SessionName] FROM [tblSession]"></asp:SqlDataSource>
                                </div>
                            </div>
                            <!-- Basic Form Inputs card start -->
                            <div class="form-group row">
                    ...
                    <div class="card-block table-border-style">
                        <div class="table-responsive">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:sasyCon %>" SelectCommand="SELECT [SessionName], [status], [startDate], [endDate], [addedBy], [dateAdded], [Status_SetBy] FROM [tblSession]"></asp:SqlDataSource>
                        </div>
                    </div>
                </div>
            </div>
